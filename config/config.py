...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1659518645").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/theseeker99/YukkiMusicBot-Seeker-Ver",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/the_seeker_s_cave"
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Master_Torrenz_s_Cave"
...
AUTO_LEAVE_ASSISTANT_TIME = int(
    getenv("ASSISTANT_LEAVE_TIME", "100000000")
